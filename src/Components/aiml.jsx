...
const AimlServices = () => {
  ...
  return (
    <>
    <HorizontalLine />
      <h1 className=" text-glow text-[50px] font-bold text-gray-100 mb-4 flex flex-row mt-9 h-[47px]"><span className="text-[#fe5d26] underline">AI/ML</span> Services</h1>
  ...
  <img
    ...
    alt="aiml"
    className="w-full max-w-[100%]  md:w-[100%] md:max-w-[721px] md:h-[481px] lg:w-[50%] lg:max-w-[721px] lg:h-[481px] md:p-8 object-cover"
  />

  {/* Paragraph on the Right */}
  <p className="text-left text-white font-segoe font-light text-[18px] leading-[26px]  md:text-[20px] md:leading-[38px] lg:text-[24px] lg:leading-[38px] max-w-full md:max-w-[100%] px-4 md:px-10 md:p-10 md:mt-auto lg:mt-auto mt-4">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
    {[...Array(4)].map((_, index) => {
      ...
      const images = [
        "./src/assets/images/aiml icon1.svg",
        "./src/assets/images/aiml icon2.svg",
        "./src/assets/images/aiml icon3.svg",
...
/>
          ...
          <div className="mt-20 group-hover:mt-12"> 
            <h3
...
<div className="flex flex-col gap-y-[40px]">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-[40px] px-5 md:px-10 ">
    ...
    <img src="./src/assets/images/AI (2).svg" alt="ai" className="w-full sm:w-[500px] h-[332.58px] mx-auto" />
  </div>

  {/* Second Grid */}
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-[40px] px-5 md:px-10">
    <img src="./src/assets/images/AI (3).svg" alt="ai" className="w-full sm:w-[500px] h-[332.58px] mx-auto" />
...
<img 
  src="./src/assets/images/aimlrobot.svg" 
  alt="aiml" 
...
<img 
  src="./src/assets/images/aitoy.svg" 
  alt="aiml" 
...
<div className="ml-10 mr-[auto] text-left p-6 sm:p-8 md:p-10">
  ...
  <div className="w-full sm:w-auto h-auto gap-[16.09px] mx-auto bg-black text-white px-4 sm:px-8 md:px-2 lg:px-32 p-6 mt-5">
  <div className="flex flex-col items-center">
    <div className="flex flex-wrap justify-evenly w-full gap-[70px] sm:gap-[50px]">
